...
export const MCP_TOOLS: McpToolInfo[] = [
  ...
  { name: "list_agent_runs", title: "列出代理", access: "read", blurb: "列出專案的代理計畫與執行狀態。回 items + total，活躍最多 100、終局最多 5；truncated=true 時不得宣稱已列出全部。" },
  ...
  { name: "list_scenes", title: "列出分鏡", access: "read", blurb: "列出專案分鏡的順序、標題、狀態與畫面／配音齊備度（唯讀摘要）。回 items + total，超過頁面上限 truncated=true。" },
  ...
  { name: "list_decisions", title: "列出專案決策", access: "read", blurb: "列出專案正式 Decision Log（來源、建立者、有效或已撤銷）。回 items + total，超過 100 筆 truncated=true。" },
  ...
  { name: "add_character", title: "新增角色卡", access: "write", idempotent: true, blurb: "為專案新增角色定裝卡（名稱／外觀／備註／參考圖）。參考圖必須同組圖片；同人同專案同名稱＋外觀 2 分鐘內重試回同一張。" },
  { name: "update_character", title: "更新角色卡", access: "write", idempotent: true, blurb: "更新既有角色定裝卡。" },
  { name: "add_scene_preset", title: "新增場景設定卡", access: "write", idempotent: true, blurb: "為專案新增場景設定卡（名稱／色板／光線／參考圖）。參考圖必須同組圖片；同人同專案同名稱＋色板 2 分鐘內重試回同一張。" },
  { name: "update_scene_preset", title: "更新場景設定卡", access: "write", idempotent: true, blurb: "更新既有場景設定卡。" },
  { name: "add_prop", title: "新增素材設定卡", access: "write", idempotent: true, blurb: "為專案新增道具／素材設定卡（名稱／外觀材質／備註）。參考圖必須同組圖片；同人同專案同名稱＋外觀 2 分鐘內重試回同一張。" },
