...
| 文件（repo `docs/`） | 說明 |
|------|------|
| [RAG 知識庫路線圖](../product/rag-knowledge-base-roadmap.md) | 現行預算注入 vs 向量 RAG；啟動條件與 MVP 邊界 |
| [素材備份與還原演練](../素材備份與還原演練.md) | 每週／每月／每季 checklist（成對備份） |
| [維運手冊](../維運手冊.md) | 遷移、備份、應變、環境變數總冊 |
