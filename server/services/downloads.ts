...
const ENTRIES: DownloadEntry[] = [
  ...
  { file: "docs/研究總報告.md", title: "全面研究總報告（缺陷×UX×fal 生態＋優先級背包）", category: "dev" },
  { file: "docs/核心缺陷審查報告.md", title: "核心缺陷深度審查（16 維度對抗驗證）", category: "dev" },
  { file: "docs/UX審查報告.md", title: "UX 缺陷專項審查（10 維度）", category: "dev" },
