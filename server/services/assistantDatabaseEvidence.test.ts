...
describe("assistant database evidence", () => {
  it("extracts useful row lookup terms from a natural-language question", () => {
    const terms = assistantDatabaseQueryTerms("請問安倞在淡水的電話是什麼？");
    expect(terms).toContain("安倞");
