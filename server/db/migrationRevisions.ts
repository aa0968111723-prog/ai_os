...
export const MIGRATION_REVISIONS: Readonly<Record<string, readonly string[]>> = {
  ...
  "0081_cutos_bridge": [
    "7a5a27ca3a216c524f228645bd013b15588ae584fef94ba72d1e569bc2d1bbde",
  ],
  "0082_cutos_memory": [
  ...
  "0084_cutos_inbound_correlation": [
    "8d2d4855a43c24702ad45b8a9e60d8ff5c5a3d6dc0968e08a8260e5e9da7fbdc",
  ],
};
