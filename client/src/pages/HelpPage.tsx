      ...
      <div className="stack">
        <MapGroup title="最上面那一排（頂欄・隨時都在）" icon="MousePointer2">
          <Spot icon="Ellipsis" name="手機底部分頁列" where="手機・螢幕最下面">
            手機沒有頂欄那排連結，改成貼底三顆：<b>專案、AI 助手、更多</b>——
            <b>AI 助手就在正中央</b>那顆彩色球，拇指最好按到的位置。
            「更多」點開就是其他目的地（今日工作台、資料中心、筆記排程、私訊、怎麼用、
            模型指南、動畫創作室、靈感頻道、共用下載）——手機上要換頁面一律從這裡走，
            右上角頭像只管「我與團隊」。舊路徑 <code>/dashboard</code>、
            <code>/planner</code> 仍可直達。
          </Spot>
          ...
          <Spot icon="Clock" name="筆記排程" where="電腦頂欄／手機「更多」">
          ...
          <Spot icon="Sparkles" name="靈感頻道" where="電腦帳號選單／手機「更多」">
