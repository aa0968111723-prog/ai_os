    ...
    <div style={{ maxWidth: 720, margin: "0 auto" }} data-fb="怎麼用頁">
      ...
      <div className="stack">
        ...
        <Faq q="什麼是「示範模式」？">
          <ul style={{ margin: 0, paddingLeft: 22 }}>
            <li>
              系統還沒設定 AI 供應商金鑰（FAL_KEY）時，會自動進入<b>示範模式</b>。
            </li>
            <li>
              這個模式下所有生成都回傳示範用的素材、<b>完全不花錢</b>，但整條流程照跑——登入、建專案、拆分鏡、逐格生成、加入分鏡、打包 zip 全都能測。
            </li>
            <li>適合先熟悉操作、跑通流程；之後填入金鑰切成正式模式，同樣的按鈕就會實際呼叫 AI 生成。</li>
            <li>
              頂欄出現金色<b>「示範模式」</b>徽章時，代表你現在就在這個模式。
            </li>
          </ul>
        </Faq>
      </div>
